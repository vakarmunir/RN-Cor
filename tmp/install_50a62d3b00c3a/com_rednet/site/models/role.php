...
class RednetModelRole  extends JModelItem { 

	
	
	protected $context = 'com_rednet.role';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Role', 'Table');
