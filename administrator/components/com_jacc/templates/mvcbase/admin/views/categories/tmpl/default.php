<?php
/**
 * @version	 $Id: default.php 96 2011-08-11 06:59:32Z michel $
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_##component##&view=categories&extension='.$extension);?>" method="post" name="adminForm">
