		...
		if (isset($file['name'])) {
			...
			if (!JFile::upload($file['tmp_name'], $filepath)) {
	            ...
	            exit;
					...
					$thumb = $folder_path.DS.$basename."_thumb.".$extension;		
					$thumbm = $folder_path.DS.$basename."_thumbm.".$extension;
					$thumbs = $folder_path.DS.$basename."_thumbs.".$extension;
					$uri =  str_replace(DS,'/',str_replace(JPATH_ROOT,'',$folder_path)).'/'.$basename.".".$extension;
					$urithumb = str_replace(DS,'/',str_replace(JPATH_ROOT,'',$folder_path)).'/'.$basename."_thumb.".$extension;							
					$urithumbm = str_replace(DS,'/',str_replace(JPATH_ROOT,'',$folder_path)).'/'.$basename."_thumbm.".$extension;
					$urithumbs = str_replace(DS,'/',str_replace(JPATH_ROOT,'',$folder_path)).'/'.$basename."_thumbs.".$extension; 
