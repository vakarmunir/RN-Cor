...
?>
<div  style="font-size:1.1em" class="yacc col width-50  fltlft">
<?php echo $tabs->startPane('howto-1'); ?>
		<?php echo $tabs->startPanel('Intro','howto-1-intro') ?>
<h2>Jacc is...</h2>
...
<?php echo $tabs->endPanel(); ?>
		<?php echo $tabs->startPanel('Guidelines','howto-1-guidlines') ?>
...
<?php echo $tabs->endPanel(); ?>
<?php echo $tabs->startPanel('Developing','howto-1-developing') ?>
...
<?php echo $tabs->endPanel(); ?>
<?php echo $tabs->startPanel('Optimize your Tables','howto-1-tables') ?>
<p>You can take full advantage of the capabilities of YACC, if you follow some rules in the respect of the naming of your tables fields:</p>
	...
	<table class="yacctable">
		...
		<tr>
			...
			<td>    None </td>
			<td>    Imageup </td>
			<td>    Allows image upload and autocreation of thumbnails</td>

		</tr>		
	</table>
<?php echo $tabs->endPanel(); ?>	

<?php echo $tabs->startPanel('Compatibility','howto-1-compat') ?>
...
<p>Example component is tested with Joomla 1.5, 1.6 and Joomla 1.7 (Beta).</p>
...
<?php echo $tabs->endPanel(); ?>
<?php echo $tabs->startPanel('Subversion','howto-1-subversion') ?>
