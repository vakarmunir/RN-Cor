...
class modAddToMenu
{
	...
	function render()
	{
		...
		$document->addScript(JURI::root(true) . '/administrator/modules/mod_addtomenu/js/script.js' . $version);
		$document->addStyleSheet(JURI::root(true) . '/administrator/modules/mod_addtomenu/css/style.css' . $version);
