...
class RednetController extends JController
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_rednet&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_rednet&view='.$this->_viewname;
				break;
		}
