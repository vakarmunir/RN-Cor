...
class RednetViewOrdertype  extends JView {
	...
	public function display($tpl = null) 
	{
		...
		$context			= 'com_rednet'.'.'.strtolower($this->getName()).'.list.';
	...
	public function _displayForm($tpl)
	{
		...
		JHTML::stylesheet( 'fields.css', 'administrator/components/com_rednet/assets/' );
