...
class RednetModelResourcesmaplist extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
			...
			$this->setState('resourcesmaplist.id', $id);			
	}

	protected function getStoreId($id = '')
	{
		// Compile the store id.
		$id	.= ':'.$this->getState('resourcesmaplist.id');
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*');
		$query->from('#__resourcesmap as a');
