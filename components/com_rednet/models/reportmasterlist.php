...
class RednetModelReportmasterlist extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
			...
			$this->setState('reportmasterlist.id', $id);			
	}

	protected function getStoreId($id = '')
	{
		// Compile the store id.
		$id	.= ':'.$this->getState('reportmasterlist.id');
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*');
		$query->from('#__reportmaster as a');
