...
/**
 * RednetModelOrdertype
 * @author $Author$
 */
 
 
class RednetModelOrdertype  extends JModelItem { 

	
	
	protected $context = 'com_rednet.ordertype';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Ordertype', 'Table');
        ...
        {
            $db = JFactory::getDbo();
            $db->setQuery("SELECT * FROM #__ordertype");
