...
$check_string = ($rental->out_of_service == 1)?("checked=checked"):("");
...
<div>
    <table border="0" style="margin-left: 35px;">
        <tr>
            <td><img style="margin-right: 5px !important;" src="<?php echo $this->baseurl ?>/templates/<?php echo $app->getTemplate() ?>/images/truck_blue.png" alt="" id="lock_icon" width="50" /></td>
            <td><h4>Edit Rental</h4></td>
        </tr>
    </table>
...
<div class="form_wrapper_app_small">
    ...
    <div class="mainform_middle">	        
        ...
        <form id="add_worker" action="index.php?option=com_rednet&task=udpate_rental&view=fleet" method="post" onSubmit="return validate_fleet();">
            <input type="hidden" name="id" id="id" value="<?php echo $rental->id ?>"/>
...
<table width="100%" border="0">
    ...
    <td>
      ...
      <input class="main_forms_field validate[required]" type="text" name="name" id="name" value="<?php echo (isset($rental->name))?($rental->name):("") ?>" tabindex="1" />      
    ...
    <td>
      ...
      <input name="type" type="text" class="main_forms_field validate[required]" id="type" tabindex="2" value="<?php echo (isset($rental->type))?($rental->type):("") ?>" />
    ...
    <td>
     ...
     <div style="border: 0px solid; width: 225px !important;height: 35px !important;display: none">
  ...
  <tr>
    <td><p class="field_para" id="p_hide">
        ...
        <input name="from" type="text" class="main_forms_field_date" id="from" tabindex="5" value="<?php echo ($from_date == '01/01/1970')?(''):($from_date); ?>" />
    ...
    <td>
      ...
      <input name="to" type="text" class="main_forms_field_date" id="to" tabindex="6" value="<?php echo ($to_date=='01/01/1970')?(''):($to_date); ?>" />
      <label for="to"></label>
      </p>    
    </td>
