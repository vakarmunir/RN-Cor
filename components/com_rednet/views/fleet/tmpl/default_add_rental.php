...
<div>
    <table border="0" style="margin-left: 35px;">
        <tr>
            <td><img style="margin-right: 5px !important;" src="<?php echo $this->baseurl ?>/templates/<?php echo $app->getTemplate() ?>/images/truck_blue.png" alt="" id="lock_icon" width="60" /></td>
            <td><h4>Add Rental</h4></td>
        </tr>
    </table>
...
<div class="form_wrapper_app_small">
    ...
    <div class="mainform_middle">	        
        ...
        <form id="add_worker" action="index.php?option=com_rednet&task=vehicle_rental_save&view=fleet" method="post" onSubmit="return validate_fleet();">
...
<table width="100%" border="0">
    ...
    <td>
     ...
     <div style="border: 0px solid; width: 170px !important;height: 35px !important;display: none !important">
  ...
  <tr>
    ...
    <td>
     ...
     <div style="border: 0px solid; width: 170px !important;height: 35px !important">
