                                                ...
                                                if($(source).attr('class') == 'truck_class assigned')
                                                {
                                                    var table_id = $(source).parent().parent().parent().parent().attr('id');                                                
                                                        ...
                                                        var table_row = "";
                                                            ...
                                                            {
                                                                table_row = "<tr><td class=\"blank\"></td><td class=\"drop\" id=\"worker_class\"><span class=\"drop_msg\">Drop Worker here</span></td><td class=\"resource_cell\"></td></tr>";
                                                            }
...
<div class="form_wrapper_app_order" style="background: none !important;min-height: 200px !important">
	
    <div class="mainform_left" style="height: 200px !important"></div>
  <div class="mainform_middle" style="height: 200px !important">
...
<div style="float: left;width: 300px;">
    ...
    <tr style="font-size: 14px;text-indent: 15px">       
