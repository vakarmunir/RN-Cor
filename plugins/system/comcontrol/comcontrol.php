...
//  Get parameters
		$com_name1 = $this->params->def('com_name1', '');
		$com_substring1 = $this->params->def('com_substring1', '');
		$com_name2 = $this->params->def('com_name2', '');
		$com_substring2 = $this->params->def('com_substring2', '');
		$com_redirect_url = $this->params->def('com_redirect_url', '');
		$com_debug = $this->params->def('com_debug', '');
